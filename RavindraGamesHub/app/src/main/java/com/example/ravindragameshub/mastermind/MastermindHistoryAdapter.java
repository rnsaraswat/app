...
public class MastermindHistoryAdapter extends RecyclerView.Adapter<MastermindHistoryAdapter.ViewHolder>{
...
//    }
        ...
        private List<MastermindHistoryItem> historyList;

        public MastermindHistoryAdapter(List<MastermindHistoryItem> historyList) {
...
//                    R.drawable.peg_circle);
        ...
        private int getPegDrawable(int colorId){
            ...
            switch(colorId){
                ...
                case 1:
                    return R.drawable.mm_peg_red;

                case 2:
                    return R.drawable.mm_peg_blue;

                case 3:
                    return R.drawable.mm_peg_green;

                case 4:
                    return R.drawable.mm_peg_yellow;

                case 5:
                    return R.drawable.mm_peg_purple;

                case 6:
                    return R.drawable.mm_peg_orange;

                case 7:
                    return R.drawable.mm_peg_cyan;

                case 8:
                    return R.drawable.mm_peg_pink;

                case 9:
                    return R.drawable.mm_peg_brown;

                case 10:
                    return R.drawable.mm_peg_gray;
            }

            return R.drawable.mm_peg_empty;
        }
